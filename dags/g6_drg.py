...
LOCAL_FILE_PATH = "/opt/airflow/data/sample-g6-DRG.txt"
CONTAINER_NAME = "airflow"
BLOB_NAME = "raw/G6/archivo_subido_g6_drg.txt"
...
@dag(
    dag_id="g6_drg",
    description="Group 6 - DRG - Uploads a local file to Azure Blob Storage with a date suffix.",
