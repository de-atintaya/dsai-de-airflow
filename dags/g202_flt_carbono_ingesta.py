"""Ingesta de archivos de huella de carbono del grupo G202 a ADLS Raw."""
...
LOCAL_DIRECTORY = Path("/opt/airflow/data/flt_carbono/incoming")
AZURE_CONN_ID = "azure_blob_storage"
CONTAINER_NAME = "airflow"
RAW_PREFIX = "raw/G202/flt_carbono"

FILES = {
    "consumo_ep_2021.csv": {"embarcacion", "anio", "mes", "total_galones"},
    "descargas_2021.csv": {"embarcacion", "fecha", "especie", "peso"},
    "embarcaciones_maestro.csv": {"embarcacion", "matricula", "propiedad"},
}
...
def upload_files_to_raw(ti, ds_nodash: str) -> None:
    ...
    for file_name in valid_files:
        ...
        source = file_path.stem.rsplit("_", 1)[0]
...
with DAG(
    dag_id="g202_flt_carbono_ingesta",
    description="Ingesta de flt_carbono desde archivos locales hacia Azure Data Lake Raw",
    default_args=default_args,
    start_date=datetime(2026, 1, 1),
    schedule=None,
    catchup=False,
    tags=["g202", "flt_carbono", "azure", "raw"],
) as dag:
